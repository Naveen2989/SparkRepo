...
public class ManFootware extends JFrame implements ActionListener,ItemListener {
	...
	ManFootware (){
		...
		l1.setForeground(new Color(0,255,0));
		      ...
		      Icon i=new ImageIcon("pre.jpg");
			    ...
			    Icon i1=new ImageIcon("prev.jpg");
		        l3=new JLabel(i1);
		        l3.setBounds(50,50,250,250);
		        c.add(l3).setLocation(70,120);
		        
		        
		        Icon i2=new ImageIcon("preve.jpg");
		        l4=new JLabel(i2);
		        ...
		        Icon i3=new ImageIcon("preview.jpg");
		        l5=new JLabel(i3);
		        l5.setBounds(100,300,250,250);
		        c.add(l5).setLocation(870, 120);
		        
		        
		        Icon i4=new ImageIcon("preevie.jpg");
		        l9=new JLabel(i4);
