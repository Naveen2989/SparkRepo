...
public class CricketCollection extends JFrame implements ActionListener,ItemListener {
	...
	CricketCollection(){
		...
		l1=new JLabel("  Cricket Collection ");
	    ...
	    Icon i=new ImageIcon("deepak.jpg");
        l2=new JLabel(i);
	    ...
	    Icon i1=new ImageIcon("raja.jpg");
        l3=new JLabel(i1);
        l3.setBounds(50,50,250,250);
        c.add(l3).setLocation(70,120);
        
        
        Icon i2=new ImageIcon("ronit.jpg");
        l4=new JLabel(i2);
        ...
        Icon i3=new ImageIcon("raj.jpg");
        l5=new JLabel(i3);
        l5.setBounds(100,300,250,250);
        c.add(l5).setLocation(870, 120);
        
        
        Icon i4=new ImageIcon("rahul.jpg");
        l9=new JLabel(i4);
...
public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b1){
			this.dispose();
			new TennisCollection ().setVisible(true);
