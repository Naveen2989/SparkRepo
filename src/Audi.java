...
public class Audi extends JFrame implements ActionListener,ItemListener {
	...
	Audi(){
		...
		l1 = new JLabel("Audi Shop");
		l1.setBounds(500, 30,200,30);
	...
	ImageIcon ii1 = new ImageIcon("images.jpg");
	l2.setIcon(ii1);
	
	 l3 = new JLabel(ii2);
	 l3.setBounds(450, 80, 240, 212);
	 ImageIcon ii2 = new ImageIcon("download (3).jpg");
	 l3.setIcon(ii2);
	 
	 l4 = new JLabel(ii3);
	 l4.setBounds(800, 80, 245, 206);
	 ImageIcon ii3 = new ImageIcon("download.jpg");
	 l4.setIcon(ii3);
	 
	 l5 = new JLabel(ii4);
	 l5.setBounds(130, 370, 200, 252);
	 ImageIcon ii4 = new ImageIcon("images (10).jpg");
	 l5.setIcon(ii4);
	 
	 l6 = new JLabel(ii5);
	 l6.setBounds(450, 390, 240, 210);
	 ImageIcon ii5 = new ImageIcon("images (13).jpg");
	 l6.setIcon(ii5);
	 
	 l7 = new JLabel(ii6);
	 l7.setBounds(800, 390, 225, 225);
	 ImageIcon ii6 = new ImageIcon("images (14).jpg");
	 l7.setIcon(ii6);
	  
	 
	 c1 = new JCheckBoxMenuItem();
	 c1.setText("INR 37500$");
	 c1.setBounds(190,300, 160, 25);
	 c1.setName("Audi1");
	 c1.addItemListener(this);
	 c1.setState(false);
	 
	 c2 = new JCheckBoxMenuItem();
	 c2.setText("INR 40000$");
