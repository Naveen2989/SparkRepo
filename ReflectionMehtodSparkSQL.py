...
peopleAge = sc.textFile("/home/cloudera/Desktop/ClouderaBack/SparkExamples/Spark/SparkSQL/people")
...
adults = sqlContext.sql("SELECT name FROM people WHERE age >= 21 AND age <= 50")
